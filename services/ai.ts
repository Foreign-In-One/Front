        ...
        data: {
          ...
          messageForEmployer: {
            korean:
              ...
              localFallback.data.messageForEmployer.korean,
            translated:
              firstCard?.nativeScript ||
              localFallback.data.messageForEmployer.translated,
  ...
  if (status === 'INSUFFICIENT_DATA') {
    ...
    legalBasis = {
      ...
      description: finding.limitation
        ...
        : finding.standard || '근로기준법 기준에 따른 사실 확인이 필요합니다.',
      protectionNotice:
