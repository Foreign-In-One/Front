...
export function parseKDate(input: string): string | null {
...
export function payDayIso(period: string, payDay: number): string {
...
export function validateDate(iso: string, rule: DateRule = {}): string | null {
  if (!iso) return "날짜를 입력해 주세요.";
